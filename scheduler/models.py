...
class TaskCategory(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="taskCategories")
...
class Task(models.Model):
    ...
    priority_level = models.CharField(max_length=1, choices=PRIORITY_LEVEL_CHOICES, default=PRIORITY_LEVEL_MEDIUM)
...
class TaggedItem(models.Model):
    ...
    task = models.ForeignKey(Task, on_delete=models.CASCADE, related_name="tagged_items")
    created_at = models.DateTimeField(auto_now_add=True)
